...
API_TOKEN = '8626785598:AAEduGmypW0XudYvteohUieELOVKLiyKKSw'
ADMIN_ID = 365353683
...
def send_welcome(message):
    ...
    # Taphatticha Database keessatti Galmeessuu (Yoo duraan hin jirre)
    ...
    # Marsariitii (Website) Botii keessatti banuuf WebApp Button qopheessuu
...
print("🚀 Botiin PythonAnywhere irratti milkiidhaan ka'eera!")
while True:
    try:
